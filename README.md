...
``` bash
curl -s https://github.com/AnhLD238/odoo-15-docker-compose/blob/master/run.sh | sudo bash -s odoo-one 10015 20015
```
...
``` bash
curl -s https://github.com/AnhLD238/odoo-15-docker-compose/blob/master/run.sh | sudo bash -s odoo-two 11015 21015
```
...
``` sh
$ git clone https://github.com/AnhLD238/odoo-15-docker-compose
...
* Default database password (**admin_passwd**) is `123`, please change it @ [etc/odoo.conf#L60](/etc/odoo.conf#L60)
